<script lang="ts">
  ...
  import RollCallDisplay from '../../conference-display/[conference_id]/roll-call/index.svelte'
  import GeneralDebateDisplay from '../../conference-display/[conference_id]/general-debate/index.svelte'
  import MotionDisplay from '../../conference-display/[conference_id]/motion/index.svelte'
  import QuestionDisplay from '../../conference-display/[conference_id]/question/index.svelte'
  ...
  import VotingDisplay from '../../conference-display/[conference_id]/voting/index.svelte'
  import PendingSpeakersListDisplay from '../../conference-display/[conference_id]/pending-speakers-list/index.svelte'
  import SuspendedDisplay from '../../conference-display/[conference_id]/suspended/index.svelte'
  import ClosedDisplay from '../../conference-display/[conference_id]/closed/index.svelte'
  import ReadyDisplay from '../../conference-display/[conference_id]/ready/index.svelte'
  import ConnectionStatusDisplay from '../../conference-display/[conference_id]/connection-status/index.svelte'
  import AttendanceChangeDisplay from '../../conference-display/[conference_id]/attendance-change.svelte'
