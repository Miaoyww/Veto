<script lang="ts">
  ...
  import { fetchPluginRegistry, fetchPluginStars } from '$lib/classes/services/plugin/plugin-registry'
  import { importModPackage } from '$lib/classes/services/plugin/mod-package-service'
...
<div class="space-y-5">
  ...
  <div>
    ...
    {:else if importState === 'loading'}
      <div
        class="flex min-h-36 flex-col items-center justify-center gap-3 rounded-lg border border-border text-muted-foreground"
      >
    ...
    {:else if importState === 'done'}
      <div
        class="flex items-center justify-between gap-3 rounded-lg border border-green-200 bg-green-50 px-4 py-3 dark:border-green-900 dark:bg-green-950/40"
      >
    ...
    {:else if importState === 'error'}
      <div
        class="flex items-center justify-between gap-3 rounded-lg border border-destructive/30 bg-destructive/5 px-4 py-3"
      >
  ...
  <div class="space-y-3">
    {#if fetchState === 'idle'}
      <div
        class="flex min-h-48 flex-col items-center justify-center gap-3 rounded-lg border border-dashed border-stone-300 text-stone-400 dark:border-stone-700 dark:text-stone-500"
      >
    ...
    {:else if fetchState === 'error'}
      <div
        class="flex min-h-48 flex-col items-center justify-center gap-3 rounded-lg border border-dashed border-destructive/40 text-destructive/70"
      >
