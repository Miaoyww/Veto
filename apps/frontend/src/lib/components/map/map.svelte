<script lang="ts">
  ...
  import { getContactDisplayRadius, isUnitConfirmed } from '$lib/classes/services/engine/registry/sensor-registry'
  ...
  import type { UnitTemplate, PlacedUnit, Faction, FacilityType } from '$lib/classes/types/battle'
  import { getNatoIcon } from '$lib/classes/utils/unit-icon'
