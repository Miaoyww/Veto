<script lang="ts">
  ...
  import { currentBattle, currentFaction, addFaction } from '$lib/classes/stores/battle/battle-store'
  ...
  import { unitPanelVisible } from '$lib/classes/stores/battle/battle-ui-store'
